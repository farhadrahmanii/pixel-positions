<x-layout>
    ...
    <x-forms.form method="POST">
        ...
        <x-forms.select name="schedule" label="schedule" placeholder="Full Time" required>
            <option>
                Full Time
            </option>
            <option>
        ...
        <x-forms.checkbox name="featured" label="featured" required />

        <x-forms.divider />

        <x-forms.input name="tag" label="Tags" placeholder="laravel, backend, php" required />
